...
X_train_list, norm_stats = normalize_features(X_train_list)
X_val_list, _ = normalize_features(X_val_list, norm_stats)
X_test_list, _ = normalize_features(X_test_list, norm_stats)
...
# RNN parameters
num_hidden = 75  # RNN hidden layer number of nodes (i.e., dimension of RNN hidden layer); `width` [8,16,32,64]
...
# with open(f'/home/arnott/git/CKD-JA-MMSc-1/Results/LossExperiment/Notebook/base_data_1.json', "w") as f:     
